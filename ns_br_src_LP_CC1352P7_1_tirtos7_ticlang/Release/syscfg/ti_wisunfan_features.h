...
/******************************************************************************
 ...
 @brief TI-15.4 Stack feature parameters definitions for borderrouter applications
...
#define FEATURE_EXTERNAL_RADIUS_SERVER_ENABLE (false)
#define FEATURE_EXTERNAL_RADIUS_SERVER_ADDR {0}
#define FEATURE_EXTERNAL_RADIUS_SERVER_SHARED_SECRET {0}
#define FEATURE_EXTERNAL_RADIUS_SERVER_SHARED_SECRET_LENGTH 0
