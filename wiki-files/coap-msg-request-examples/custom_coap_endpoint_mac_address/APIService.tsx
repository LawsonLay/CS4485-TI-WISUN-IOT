...
export class APIService {
  ...
  static async incrementCount(ipAddresses: string[]){
    const requestOpts = {
      method: 'POST',
      headers: {
        Accept: 'application/json',
    ...
    return await APIService.fetchJSON(`/postCount`, requestOpts);

  }
  static async getMACAddress(ipAddresses: string[]){
    const requestOpts = {
      method: 'GET',
      headers: {
        Accept: 'application/json',
    ...
    return await APIService.fetchJSON(`/getMACAddress`, requestOpts);
